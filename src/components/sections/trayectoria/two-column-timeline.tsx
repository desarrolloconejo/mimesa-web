      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start relative">
        ...
        <div className="hidden lg:block lg:col-span-7 self-start lg:sticky lg:top-36 z-20">
          ...
          <div className="relative rounded-3xl bg-white border border-gray-100 shadow-xl p-5 sm:p-7 overflow-hidden">
            ...
            <div className="absolute right-3 -bottom-4 pointer-events-none select-none text-[90px] sm:text-[130px] font-black text-[#1a3c6a]/[0.03] tracking-tighter leading-none">
            ...
            <div className="relative z-10 space-y-1 mb-3.5">
              <h3 className="text-xl sm:text-2xl font-black text-[#1a3c6a] leading-tight">
            ...
            {/* Story Narrative */}
            <div className="relative z-10 space-y-2 text-xs sm:text-sm text-gray-600 font-light leading-relaxed mb-3.5">
            ...
            <div className="relative z-10 p-3 rounded-xl bg-[#009539]/5 border border-[#009539]/20 mb-3.5 flex items-start gap-2.5">
              ...
              <div className="text-xs">
                <span className="font-bold text-[#1a3c6a]">Logro Consolidado: </span>
                <span className="text-gray-700">{activeMilestone.achievement}</span>
              </div>
            </div>

            {/* Metric Highlight Box */}
            <div className="relative z-10 p-3.5 sm:p-4 rounded-2xl bg-gradient-to-br from-[#1a3c6a] via-[#122c4f] to-[#0a182b] text-white shadow-md flex items-center justify-between gap-3">
              ...
              <span className="text-xl sm:text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#30deda] via-[#94c11e] to-white shrink-0">
                {activeMilestone.metric}
              </span>
            </div>

            {/* Bottom Position Indicator */}
            <div className="relative z-10 pt-2.5 flex items-center gap-1.5 text-[11px] text-gray-400 font-light">
              <BookOpen className="w-3 h-3 text-[#02afab]" />
        ...
        <div className="col-span-1 lg:col-span-5 relative py-2 max-w-2xl mx-auto lg:max-w-none w-full">
          ...
          <div className="absolute left-[34px] sm:left-[38px] top-6 bottom-6 w-1 bg-gradient-to-b from-[#02afab] via-[#009539] to-[#94c11e] rounded-full opacity-60" />
              ...
              return (
                <div
                  ...
                  className={`relative rounded-2xl transition-all duration-300 border p-3.5 sm:p-4 ${
                    isMobileActive
                      ? "bg-white shadow-xl border-[#02afab]/40 ring-2 ring-[#02afab]/20"
                      : "bg-white/70 border-gray-100/80 shadow-sm"
                  } ${
                    isDesktopActive
                      ? "lg:bg-white lg:shadow-xl lg:border-[#02afab]/40 lg:-translate-x-1 lg:ring-2 lg:ring-[#02afab]/20"
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative shrink-0">
                      <div
                        className={`w-11 h-11 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-all duration-300 ${
                          isMobileActive
                            ? "bg-white shadow-lg ring-4 ring-[#02afab] scale-105 shadow-[#02afab]/25"
                            : "bg-white shadow-sm ring-2 ring-gray-200"
                        } ${
                          isDesktopActive
                            ? "lg:bg-white lg:shadow-lg lg:ring-4 lg:ring-[#02afab] lg:scale-110 lg:shadow-[#02afab]/25"
                      ...
                      <div className="flex items-center gap-2 mb-0.5">
                        <span
                          className={`text-base font-black tracking-tight transition-colors ${
                            isMobileActive ? "text-[#1a3c6a]" : "text-gray-700"
                          } ${
                            isDesktopActive
                              ? "lg:text-[#1a3c6a]"
                              : "group-hover:lg:text-[#1a3c6a]"
                          }`}
                        >
                          {milestone.year}
                        </span>
                        <span
                          className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full transition-colors ${
                            isMobileActive
                              ? "bg-[#02afab]/15 text-[#02afab] font-extrabold"
                              : "bg-gray-100 text-gray-400"
                          } ${
                            isDesktopActive
                              ? "lg:bg-[#02afab]/15 lg:text-[#02afab] lg:font-extrabold"
                    ...
                    <div
                      className={`p-1 rounded-full transition-all duration-300 ${
                        isMobileActive
                          ? "rotate-90 text-[#02afab]"
                          : "rotate-0 text-gray-400"
                      } ${
                        isDesktopActive
                          ? "lg:rotate-0 lg:text-[#02afab] lg:translate-x-1 lg:opacity-100"
                  ...
                  >
                    <div className="overflow-hidden">
                      ...
                      {/* Story Narrative */}
                      <div className="space-y-2 text-xs text-gray-600 font-light leading-relaxed mb-3">
                      ...
                      {/* Metric Highlight Box */}
                      <div className="p-3 rounded-xl bg-gradient-to-br from-[#1a3c6a] via-[#122c4f] to-[#0a182b] text-white shadow-sm flex items-center justify-between gap-3 mb-2">
                        <div className="space-y-0.5">
                        ...
                        <span className="text-lg font-black text-transparent bg-clip-text bg-gradient-to-r from-[#30deda] via-[#94c11e] to-white shrink-0">
                          {milestone.metric}
                        </span>
                      </div>
                      ...
                      <div
                        ...
                        className="pt-1 pb-0.5 flex items-center justify-center gap-1 text-[11px] text-[#02afab] font-medium hover:underline cursor-pointer select-none"
                      >
