 ...
 * - Treatment D: Blueprint Schematic Grid & Cyanotype Wash (Panel 3)
 * - Highly visible Prussian blue texture (#183c6b) + technical blueprint overlay
 * - Slide 15 Grain / Noise texture (+11, +20, +27)
 * - Slide 12: Bleeding brand leaves strictly in powdery white at top-right
 * - Accents in Verde Amarillo / Lima (#95c11e) & Verde (#009539)
 */
export function ContactoHero() {
  return (
    <section className="relative min-h-[460px] sm:min-h-[480px] lg:min-h-[500px] flex flex-col justify-center pt-28 sm:pt-32 lg:pt-36 pb-16 sm:pb-20 lg:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#183c6b] text-white select-none">
      ...
      {/* 4. Gentle Prussian Blue Vignette for Text Contrast */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#143560]/85 via-[#183c6b]/50 to-transparent sm:w-2/3 pointer-events-none z-0" />
      <div className="absolute inset-0 bg-gradient-to-t from-[#143560]/60 via-transparent to-black/20 pointer-events-none z-0" />

      {/* 5. Slide 12: Bleeding Brand Leaves in white at top-right */}
      <BleedingBrandLeaves
        position="top-right"
        variant="white"
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full">
        <FadeIn direction="up" delay={0.1} className="space-y-4 sm:space-y-6 max-w-3xl lg:max-w-4xl xl:max-w-5xl">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] xl:text-6xl font-black text-white tracking-tight leading-[1.12] font-heading drop-shadow-md">
            <span className="block sm:whitespace-nowrap">Ponte en contacto con</span>
            <span className="block sm:whitespace-nowrap text-[#95c11e]">Grupo Mimesa</span>
          </h1>
