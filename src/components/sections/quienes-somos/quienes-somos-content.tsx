    ...
    <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36 space-y-32 md:space-y-48">
      ...
      <div className="absolute top-10 left-1/2 -translate-x-1/2 pointer-events-none select-none z-0 overflow-hidden w-full text-center">
        <ParallaxElement speed={-0.35} horizontalSpeed={0.15} fadeEffect="in-out" fadeIntensity={1.0}>
          <span className="text-[120px] sm:text-[180px] md:text-[240px] font-heading font-black text-[#183c6b]/[0.03] uppercase tracking-normal leading-none block">
            MIMESA
          </span>
        </ParallaxElement>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <FadeIn direction="up" delay={0.08} className="lg:col-span-6 space-y-6">
          ...
          <ParallaxElement speed={0.28}>
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-[#183c6b] leading-[1.08] tracking-tight">
              ¿Quiénes{" "}
          ...
          <ParallaxElement speed={0.20}>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed font-normal">
              Somos un <strong className="text-[#183c6b] font-bold">grupo empresarial especializado en producción de alimentos</strong>, conformado por diversas unidades de negocio que brindan productos y soluciones para impactar vidas y ayudar a enriquecer a Venezuela.
            </p>
          </ParallaxElement>
        ...
        <FadeIn direction="up" delay={0.16} className="lg:col-span-6 relative">
          ...
          <ParallaxElement speed={-0.08} fadeEffect="in-out" fadeIntensity={0.95}>
            <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-white group">
              ...
              <div className="absolute bottom-5 left-5 right-5 p-4 rounded-2xl glass-panel text-[#183c6b]">
                <p className="text-xs font-bold uppercase tracking-wider text-[#02aeaa]">
          ...
          <div className="absolute -bottom-6 -left-4 z-20 hidden sm:block">
            <ParallaxElement speed={0.25} fadeEffect="in-out" fadeIntensity={1.0}>
              <div className="glass-panel p-4 rounded-2xl shadow-xl border border-white/80 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-[#183c6b]">Compromiso País</p>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <FadeIn direction="up" delay={0.16} className="lg:col-span-6 relative order-2 lg:order-1">
          ...
          <div className="absolute -bottom-8 -left-6 z-0 hidden sm:block">
            <div className="w-56 h-56 rounded-full bg-[#02aeaa]/15 blur-3xl" />
          </div>
          ...
          <ParallaxElement speed={-0.08} fadeEffect="in-out" fadeIntensity={0.95}>
            <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-white group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#183c6b]/85 via-[#183c6b]/20 to-transparent opacity-75" />

              <div className="absolute top-5 left-5">
                <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/95 backdrop-blur-md text-xs font-bold text-[#183c6b] shadow-lg">
                  <History className="w-3.5 h-3.5 text-[#02aeaa]" />
                  Nuestra Historia
                </span>
              </div>
          ...
          <div className="absolute -bottom-6 right-6 z-20 hidden sm:block">
            <ParallaxElement speed={0.25} fadeEffect="in-out" fadeIntensity={1.0}>
              <div className="glass-panel px-5 py-3.5 rounded-2xl shadow-xl border border-white/80 flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-[#95c11e] text-[#183c6b]">
                  <Utensils className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-xs font-bold text-[#183c6b]">En cada hogar</p>
        ...
        <FadeIn direction="up" delay={0.08} className="lg:col-span-6 space-y-6 order-1 lg:order-2">
          ...
          <ParallaxElement speed={0.28} fadeEffect="in-out" fadeIntensity={1.1}>
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-[#183c6b] leading-[1.08] tracking-tight font-heading">
              ¿Por qué{" "}
          ...
          <ParallaxElement speed={0.20} fadeEffect="in-out" fadeIntensity={1.0}>
            <div className="space-y-4 text-sm sm:text-base text-gray-600 leading-relaxed font-normal">
              <p>
                <strong className="font-heading font-bold text-[#183c6b]">Mimesa</strong> es un nombre que viene de uno de nuestros primeros productos que nos abrió las puertas al mercado venezolano. Es parte de nuestra historia y es recordado por nuestras audiencias.
              </p>
              <p>
                Honramos nuestra trayectoria en el país y nos unimos para trabajar en un solo propósito, <span className="text-[#183c6b] font-semibold italic">tal como una familia se une en la mesa de sus hogares.</span>
              </p>
            </div>
          </ParallaxElement>
