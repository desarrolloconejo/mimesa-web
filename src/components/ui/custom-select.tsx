...
export function CustomSelect({
  ...
  const triggerClasses = isLight
    ? `w-full px-4 py-3.5 rounded-2xl bg-[#f8fafc] border text-[#183c6b] text-sm flex items-center justify-between transition-all duration-200 cursor-pointer select-none text-left ${
        isOpen
          ? "bg-white border-[#02aeaa] ring-4 ring-[#02aeaa]/10 shadow-sm"
    ...
    : `w-full px-4 py-3 rounded-xl border text-white text-sm flex items-center justify-between transition-all duration-200 cursor-pointer select-none text-left ${
        isOpen
          ? "bg-[#0d2646] border-[#02aeaa] ring-1 ring-[#02aeaa]"
          ...
          {normalizedOptions.map((opt) => {
            ...
            if (isLight) {
              optionItemClasses = isSelected
                ? "px-3.5 py-2.5 rounded-xl text-xs sm:text-sm text-[#02aeaa] bg-[#02aeaa]/10 font-bold flex items-center justify-between transition-colors duration-150 cursor-pointer select-none"
                : "px-3.5 py-2.5 rounded-xl text-xs sm:text-sm text-slate-700 hover:text-[#02aeaa] hover:bg-slate-50 flex items-center justify-between transition-colors duration-150 cursor-pointer select-none";
            } else {
              optionItemClasses = isSelected
                ? "px-3.5 py-2.5 rounded-xl text-xs sm:text-sm text-[#30deda] bg-[#02aeaa]/20 font-bold flex items-center justify-between transition-colors duration-150 cursor-pointer select-none"
